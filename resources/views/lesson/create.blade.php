                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('cource_id',$cources, null, ['autocomplete'=>'OFF','id'=>'cource_id','required'=>true,'class' => "form-control ".($errors->has('cource_id') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status', \App\Models\Lesson::$statuses,null, ['autocomplete'=>'OFF','id'=>'status','required'=>true,'class' => "form-control ".($errors->has('status') ? 'is-invalid' : '')]) !!}
